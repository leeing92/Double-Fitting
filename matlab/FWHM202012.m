...
%--------------------
% figure(5);subplot(1,2,2);imshow(TransSub,[]);hold on
%  rectangle('Position',[1,heng,size(TransSub,2),3],'EdgeColor','r');hold off
%  subplot(1,2,1);imagesc(Sub2fit);   
 %--------------------     
...
%               ShowFitProcess( RenderedIm,x0,y0,r,X, Line2fit,result, Angle,fitresult,Method);   
                    % If Single Fitting is not suitable, Try Two Structure
